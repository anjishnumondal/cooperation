...
<html>
	...
	<body>
		...
		<div class="col-md-12 col-xs-12">
			...
			<div class="col-md-8 col-xs-12" style="border-left: 10px double #077FFF; margin:1%; padding-top:4%; padding-bottom:4%" align="center">
				<?php
					include 'modules/reportpublication-content.php'
				?>
			</div>
		</div>
