...
<html>
	...
	<body>
		...
		<div class="col-md-12 col-xs-12">
			...
			<div class="col-md-8 col-xs-12" style="border-left: 10px double #077FFF; margin:1%; padding-top: 2.5%; font-family:Book Antiqua; font-size:16px; text-align:justify">
				<?php
					include 'modules/actsrulesbylaws-content.php';
				?>
			</div>
		</div>
