...
<html>
	<head>
		...
		<style type="text/css">
			...
			.title {
				background:url('images/header-img-black.png');
	...
	<body>
		...
		<div class="col-md-12 col-xs-12">
			...
			<div class="col-md-8 col-xs-12" style="border-left: 10px double #077FFF; margin:1%; padding-top:4%; padding-bottom:18%" align="center">
				<?php
					include 'modules/circularpublication-content.php'
				?>
			</div>
		</div>
