...
<html>
	...
	<body>
		...
		<div class="title" align="center">
			<h1>Dharmapur Seed Processing Unit</h1>
		</div>
		...
		<div class="col-md-12 col-xs-12">
			...
			<div class="col-md-8 col-xs-12" style="border-left: 10px double #077FFF; padding-top:5%; margin:1%;">
				<div class="container" id="container">    
			        <div class="gallery">
			            <a tabindex="1"><img src="images/dharmapur/1.jpg"></a>
			            <a tabindex="1"><img src="images/dharmapur/2.jpg"></a>
			            <a tabindex="1"><img src="images/dharmapur/3.jpg"></a>
